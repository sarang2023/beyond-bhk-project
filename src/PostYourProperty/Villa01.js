                                    ...
                                    <div class="col-sm-12 col-md-8 mt-1">
                                      <div class="my-3">
                                        <div class="d-flex justify-content-around responsive2">
                                          <button
                                            type="button"
                                            class="btn   rounded-pill flex-grow-2 text-light border border-0 res-button res-button-1"
                                            style={{
                                              backgroundColor:
                                                "rgb(38,118,195)",
                                            }}
                            ...
                            <div class="mt-2 text-start">
                              ...
                              <div class="d-flex flex-column flex-md-row ">
                                <div class="py-1">
                                  <button
                                    type="button"
                                    class="btn mx-3 rounded-pill flex-grow-8 text-light res-button margin-4"
                                    style={{
                                ...
                                <div class="py-1">
                                  ...
                                  <button
                                    type="button"
                                    class="btn rounded-pill flex-grow-8 text-light res-button margin-4"
                                    style={{
                                ...
                                <div class="col ">
                                  <div class="d-flex flex-column flex-md-row ">
                                    ...
                                    <div class="p-2">
                                      ...
                                      <button
                                        type="button"
                                        class="btn  rounded-pill flex-grow-1 text-light res-button res-button-1 "
                                        style={{
                                          backgroundColor: "rgb(38,118,195)",
                                        }}
                                      >
