            ...
            <div class="row">
              <div class="col-sm-4 mb-3 mb-sm-0">
                <div class="card rounded-0 border-0 h-100">
                  <div class="card-body">
                    <h5 class="text-start fw-bold">Seaside Serenity Villa</h5>
                    ...
                    <h5 class="card-text fw-bold">$550,000</h5>
        ...
        <div class="row align-items-start">
          <div class="row">
            <div class="col-sm-6 mb-3 mb-sm-0">
              <div class="card bg-transparent border-0">
                <div class="card-body">
                  <h5 class="card-title mx-4 fw-bold">Amenities</h5>
                  <div class="row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                      <div class="card bg-transparent border-0">
                        <div class="card-body">
                          <div class="d-flex flex-column fw-semibold">
                            ...
                            <div class="p-2">
                              <i class="fa-solid fa-wind"></i>&nbsp;Central Air
                            </div>
                            <div class="p-2">
                        ...
                        <div class="card-body">
                          <div class="d-flex flex-column">
                            ...
                            <div class="p-2">
                              ...
                              <span className="mx-3">Security System</span>
                            </div>
                          </div>
                        </div>
                      </div>
