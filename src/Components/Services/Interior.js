            ...
            <div class="card border-0 my-3">
              <div class="card-body">
                ...
                >
                  ...
                  minus consectetur quis magnam consequatur eos quas nemo
            ...
            <div class="card border-0 my-2">
              <div class="card-body">
                ...
                >
                  ...
                  allowing products to become more sentient and connected,
                  ...
                  lives. Through first and secondary research, we identify what
                  will really matter to users and we never let go of the vision
                  that inspires great products.
                </p>
                <p
                  class="card-text col-sm-8 mx-auto"
                  style={{ fontSize: "14px" }}
              ...
              <div class="row">
                <div class="col-sm-4 mb-3 mb-sm-0">
                  <div class="card border border-0 bg-transparent">
                    <div class="card-body ">
                      <p class="card-text">
                        Group One is excited to present this exeptional property
                        in the prestegious location.
                      </p>
                    </div>
                  </div>
                </div>
                        ...
                        <div className="">
                          <div class="card">
                            <div class="card-body">
                              ...
                              <p class="card-text">
                                Efficient tenant screening and maintenance turn
                                my property into hassle-free income.
                              </p>
                              <div class="d-flex flex-row">
                                <div class="p-2">
                                  <i
