                  ...
                  <div class="card border-0">
                    <div class="card-body">
                      ...
                      <p class="card-text text-start fs-5 lh-1">
                        ...
                        opportunities for everyone to have a home; our mission
                        is to become the real estate agency of choice. This is
                        our chance to join a community of industry
                        professionals,renowned for their passion, service and
                        results. Are you ready to evolve your career with Image?
                      </p>
                      <p class="card-text text-start fs-5 lh-1">
                        Today's market is rapidly evolving. We understood that
                        our team needs to consistently perform while maintaining
                        the flexibility to adapt and adjust to the needs of
                        their clients in today's fast paced environment. We have
                        invested heavily to provide the tools you need to
                        deliver world class service at the touch of a button.
                      </p>
                      <p class="card-text text-start fs-5 lh-1">
                        We have designed our business to be a home in which
                        property professionals can thrive. Here you are
                        encouraged to do what you love with all the support that
                        you need, always with a dash of fun along the way.
                      </p>
                      <p class="card-text text-start fs-5">
                        Make your future,now. Imagine what life could be like
                        with Image.
                      </p>
                    </div>
                  </div>
